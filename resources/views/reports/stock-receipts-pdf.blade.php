...
<head>
    ...
    <style>
        ...
        .text-green { color: #15803d; font-weight: 900; }
...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-cell">
            ...
            <div class="value">{{ number_format($summary['total_quantity'], 2, ',', '.') }}</div>
        </div>
        <div class="summary-cell">
        ...
        <tbody>
            @forelse ($rows as $row)
                ...
                <tr>
                    ...
                    <td class="text-right">{{ $unitPrice ? 'Rp '.number_format($unitPrice, 0, ',', '.') : '-' }}</td>
