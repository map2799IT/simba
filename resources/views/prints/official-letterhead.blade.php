...
@if (!empty($officialDocument['number']) || !empty($reportTitle) || !empty($periodLabel))
    <table style="width:100%; border-collapse:collapse; table-layout:fixed; margin-bottom:6px;">
        <tr>
            <td style="vertical-align:bottom; text-align:left; font-size:7px; color:#64748b;">
                @if (!empty($officialDocument['number']))
                    <div style="font-weight:bold; text-transform:uppercase; color:#1769ff;">No: {{ $officialDocument['number'] }}</div>
                @endif
